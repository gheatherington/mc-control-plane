...
- Phase 14 is complete: the panel now exposes scoped backup APIs and a live Backups page for archive create/list/inspect/delete flows, exclusion-aware backup creation, confirmation-gated restore requests, and explicit backup audit events under `/opt/fabric-minecraft-server/backups`.
